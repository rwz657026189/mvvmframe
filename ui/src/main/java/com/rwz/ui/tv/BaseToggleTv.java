...
//        LogUtil.d("setCheckedMe",checkedMe);
    ...
    protected void setState() {
        ...
        LogUtil.d("checkedMe",checkedMe, mCheckedSrc, mUncheckedSrc, mPosition, getPaddingLeft(), getPaddingTop(), getPaddingRight(), getPaddingBottom());
        //设置背景
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (TextUtils.isEmpty(text)) {
            ...
            LogUtil.d("BaseToggleTv", "bitmapWidth = " + bitmapWidth, "width = " + width);
            if (bitmapWidth > 0) {
