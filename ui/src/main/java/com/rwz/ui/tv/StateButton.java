...
import com.rwz.commonmodule.config.Orientation;
import com.rwz.commonmodule.utils.app.ColorUtil;
...
public class StateButton extends SingleCenterTextView {
    ...
    private void init() {
        LogUtil.d(TAG, "init", "isInterceptDisable = " + isInterceptDisable, "isEnablePressState = " + isEnablePressState, "isEnableDisableState = " + isEnableDisableState
        , "mRoundOrientation = " + mRoundOrientation);
        if (mPaint == null) {
            mPaint = new Paint();
        ...
        if (mColorAnim == null) {
            ...
            mColorAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    //字体背景
                    int paintColor = ColorUtil.getTransitionColor(mEnableColor, mPressColor, progress);
                    mPaint.setColor(paintColor);
                    //字体颜色
                    int textColor = ColorUtil.getTransitionColor(mEnableTextColor, mPressTextColor, progress);
...
//        LogUtil.d(TAG, "dispatchTouchEvent", "action = " + action);
   ...
   /* @Override
    ...
    private static class WrapOnClickListener implements OnClickListener {

        OnClickListener listener;

        public WrapOnClickListener(OnClickListener listener) {
