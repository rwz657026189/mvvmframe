...
public class DrawableTextView extends AppCompatTextView {
    ...
    public DrawableTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (drawables[0] != null) {
            widths[0] = array.getDimensionPixelSize(R.styleable.DrawableTextView_leftDrawableWidth, drawables[0].getIntrinsicWidth());
            heights[0] = array.getDimensionPixelSize(R.styleable.DrawableTextView_leftDrawableHeight, drawables[0].getIntrinsicHeight());
        }
        if (drawables[1] != null) {
            widths[1] = array.getDimensionPixelSize(R.styleable.DrawableTextView_topDrawableWidth, drawables[1].getIntrinsicWidth());
            heights[1] = array.getDimensionPixelSize(R.styleable.DrawableTextView_topDrawableHeight, drawables[1].getIntrinsicHeight());
        }

        if (drawables[2] != null) {
            widths[2] = array.getDimensionPixelSize(R.styleable.DrawableTextView_rightDrawableWidth, drawables[2].getIntrinsicWidth());
            heights[2] = array.getDimensionPixelSize(R.styleable.DrawableTextView_rightDrawableHeight, drawables[2].getIntrinsicHeight());
        }
        if (drawables[3] != null) {
            widths[3] = array.getDimensionPixelSize(R.styleable.DrawableTextView_bottomDrawableWidth, drawables[3].getIntrinsicWidth());
            heights[3] = array.getDimensionPixelSize(R.styleable.DrawableTextView_bottomDrawableHeight, drawables[3].getIntrinsicHeight());
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        LogUtil.d("drawables[0] = " + drawables[0]);
        if (drawables[0] != null) {
            int left = (int) (centerX - drawablePadding - halfTextWidth - widths[0]);
            int top = (int) (centerY - heights[0] / 2);
            LogUtil.d("left = " + left , "top = " + top , "widths[0] = " + widths[0] , "heights[0] = " + heights[0]);
    ...
    private void translateText(Canvas canvas, int drawablePadding) {
        ...
        LogUtil.d("translateWidth = " + translateWidth ,"translateHeight = " + translateHeight);
