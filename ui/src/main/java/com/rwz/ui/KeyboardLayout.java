...
public class KeyboardLayout extends FrameLayout {
    ...
    private class KeyboardOnGlobalChangeListener implements ViewTreeObserver.OnGlobalLayoutListener {
        ...
        public void onGlobalLayout() {
            ...
            LogUtil.d(TAG , "onGlobalLayout","keyboardHeight = " + Math.abs(keyboardHeight));
   ...
   /* public interface KeyboardLayoutListener {
    ...
    public static abstract class KeyboardLayoutListener {
        ...
        public void  onKeyboardChanged(boolean isActive, int keyboardHeight) {
            LogUtil.d(TAG, "onKeyboardChanged", "this.keyboardHeight = " + this.keyboardHeight, "keyboardHeight = " + keyboardHeight, "isActive = " + isActive);
