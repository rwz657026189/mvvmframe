    ...
    public static void init(Context context) {
        ...
        QbSdk.initX5Environment(context, new QbSdk.PreInitCallback() {
            ...
            public void onCoreInitFinished() {
                LogUtil.d(TAG , "QbSdk", "onCoreInitFinished");
            }

            @Override
            public void onViewInitFinished(boolean b) {
                LogUtil.d(TAG , "QbSdk", "onViewInitFinished, b = " + b);
            }
        });
    }
...
//        LogUtil.d(TAG, "setProxy", "result = " + result);
    }
    ...
    public void loadUrl(String url, String postParams, boolean isAddBackStack) {
        LogUtil.d(TAG, "loadUrl", "url = " + url, "  postParams = " + postParams);
