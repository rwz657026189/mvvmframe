...
public class SysWebChromeClient extends WebChromeClient {
    ...
    public boolean onCreateWindow(WebView view, boolean isDialog, boolean isUserGesture, Message resultMsg) {
        LogUtil.d(TAG, "onJsAlert","isDialog = " + isDialog, "message =" + resultMsg);
    ...
    private void showFullScreen(View view, CustomViewCallback callback) {
        LogUtil.d(TAG, "showFullScreen", "mXCustomView = " + mXCustomView);
    ...
    public void onHideCustomView() {
        ...
        LogUtil.d(TAG, "onHideCustomView", "mXCustomView = " + mXCustomView);
