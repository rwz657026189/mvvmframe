...
public class InstallHelp {
    ...
    public static void installApk(Context context, String apkPath) {
        LogUtil.d("installApk","context = " + context, "apkPath = "+apkPath);
    ...
    public static void installApk(Context context, File file) {
        LogUtil.d("installApk", "context = " + context, "file = " + file);
        if (context != null && file != null && file.exists()) {
            try {
                ///storage/emulated/0/Android/data/com.touchrom.yuliao/files/storage/emulated/0/yuliao/temp/yuliao(3).apk
                LogUtil.d("installApk", "context = " + context, "path = " + file.getAbsolutePath());
                ...
                if(Build.VERSION.SDK_INT >= 24) { //判读版本是否在7.0以上
                    ...
                    LogUtil.d("installApk", "context = " + context, "path = " + file.getAbsolutePath(), "packageName = " + packageName);
                ...
                LogUtil.d("installApk", "install result = " + result);
                if(result)
            ...
            LogUtil.d("installApk", "context = " + context, "file.exists = " + file.exists());
        }
    }
    ...
    public static void installApk(Context context, Uri uri) {
        LogUtil.d("installApk", "context = " + context, "uri = " + uri);
