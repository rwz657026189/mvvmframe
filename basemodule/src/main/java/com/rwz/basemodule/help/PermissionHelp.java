...
public class PermissionHelp {
    ...
    public static boolean hasWritePermission() {
        return !hasM() || ContextCompat.checkSelfPermission(BaseApplication.getInstance(), Manifest.permission.WRITE_EXTERNAL_STORAGE)
    ...
    public static boolean hasInstallApp() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            result = BaseApplication.getInstance().getPackageManager().canRequestPackageInstalls();
        }
        return result;
    }
    ...
    public static boolean hasRecordPermission() {
        return  !hasM() || ContextCompat.checkSelfPermission(BaseApplication.getInstance(), Manifest.permission.RECORD_AUDIO)
                == PackageManager.PERMISSION_GRANTED;
    }
    ...
    public static boolean hasCameraPermission() {
        return  !hasM() || ContextCompat.checkSelfPermission(BaseApplication.getInstance(), Manifest.permission.CAMERA)
                == PackageManager.PERMISSION_GRANTED;
    }
    ...
    public static boolean hasMulPermission(String... permission) {
        ...
        for (String aPermission : permission) {
            if (ContextCompat.checkSelfPermission(BaseApplication.getInstance(), aPermission) != PackageManager.PERMISSION_GRANTED) {
                return false;
            }
        }
        return true;
